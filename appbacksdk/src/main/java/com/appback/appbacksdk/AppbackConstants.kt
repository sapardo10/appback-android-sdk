...
object AppbackConstants {
    ...
    const val TRANSLATION_NOT_FOUND =
        "We couldn't find the translation you are trying to find, review your router and key"
    const val TOGGLE_NOT_FOUND =
        "We couldn't find the toggle you are trying to find, review your router and key"
}